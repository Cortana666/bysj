<?php
/* Smarty version 3.1.33, created on 2019-06-03 10:09:46
  from 'D:\html\bysj\application\views\templates\admin\special_lsits.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5cf4f1ea7ecca5_53320697',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2c153ce6b22db9749011d31d4a1125cda36447af' => 
    array (
      0 => 'D:\\html\\bysj\\application\\views\\templates\\admin\\special_lsits.html',
      1 => 1559556580,
      2 => 'file',
    ),
  ),
...
function content_5cf4f1ea7ecca5_53320697 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
    ...
    <div class="x-body">
        <div class="layui-row">
            <form class="layui-form layui-col-md12 x-so">
                <input type="text" name="name" placeholder="请输入专业名称" autocomplete="off" class="layui-input" value="<?php echo (($tmp = @$_GET['name'])===null||$tmp==='' ? '' : $tmp);?>
">
...
?>
                    <tr>
                        <td>
                            <div class="layui-unselect layui-form-checkbox" lay-skin="primary" data-id='<?php echo $_smarty_tpl->tpl_vars['item']->value['spe_id'];?>
'><i class="layui-icon">&#xe605;</i></div>
                        </td>
                        <td>
                            <?php echo $_smarty_tpl->tpl_vars['item']->value['spe_id'];?>
                        ...
                        <td class="td-manage">
                            <a title="编辑" onclick="x_admin_show('编辑','/admin/special/update?spe_id=<?php echo $_smarty_tpl->tpl_vars['item']->value['spe_id'];?>
')" href="javascript:;">
                                <i class="layui-icon">&#xe642;</i>
                            </a>
                            <a title="删除" onclick="member_del(this,'<?php echo $_smarty_tpl->tpl_vars['item']->value['spe_id'];?>
')" href="javascript:;">
                                <i class="layui-icon">&#xe640;</i>
                            </a>
                        </td>
