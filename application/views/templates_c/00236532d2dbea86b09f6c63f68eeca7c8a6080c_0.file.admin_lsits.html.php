...
'><i class="layui-icon">&#xe605;</i></div>
                        ...
                        <td>
                            <?php if ($_smarty_tpl->tpl_vars['item']->value['type'] > 0) {?>学院<?php } else { ?>
                                <?php if ($_smarty_tpl->tpl_vars['item']->value['type'] == -1) {?>学校<?php } elseif ($_smarty_tpl->tpl_vars['item']->value['type'] == -2) {?>导师<?php }?>
                            <?php }?> 
                        </td> 
                        <td class="td-status">
...
')" href="javascript:;" title="<?php if ($_smarty_tpl->tpl_vars['item']->value['status'] != 1) {?>启用<?php } else { ?>停用<?php }?>">
                            ...
                            <a title="编辑" onclick="x_admin_show('编辑','/admin/admin/update?id=<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
')" href="javascript:;">
