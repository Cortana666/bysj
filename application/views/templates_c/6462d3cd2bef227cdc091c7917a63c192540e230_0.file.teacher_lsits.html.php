<?php
/* Smarty version 3.1.33, created on 2019-06-03 14:45:39
  from 'D:\html\bysj\application\views\templates\admin\teacher_lsits.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5cf5329381ff63_36922896',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '6462d3cd2bef227cdc091c7917a63c192540e230' => 
    array (
      0 => 'D:\\html\\bysj\\application\\views\\templates\\admin\\teacher_lsits.html',
      1 => 1559573137,
      2 => 'file',
    ),
  ),
...
function content_5cf5329381ff63_36922896 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
...
">
        ...
        <xblock>
            ...
            <button class="layui-btn" onclick="x_admin_show('添加用户','/admin/teacher/add')"><i
 ...
 条</span>
        ...
        <table class="layui-table x-admin">
            ...
            <tbody>
                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['aTeacher']->value, 'item');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['item']->value) {
?>
                    <tr>
                        <td>
                            <div class="layui-unselect layui-form-checkbox" lay-skin="primary" data-id='<?php echo $_smarty_tpl->tpl_vars['item']->value['tea_id'];?>
'><i
                                    class="layui-icon">&#xe605;</i></div>
                        </td>
                        <td>
                            <?php echo $_smarty_tpl->tpl_vars['item']->value['tea_id'];?>
                        ...
                        <td class="td-status">
                            <span class="layui-btn layui-btn-normal layui-btn-mini <?php if ($_smarty_tpl->tpl_vars['item']->value['status'] != 1) {?>layui-btn-disabled<?php }?>">
                                <?php if ($_smarty_tpl->tpl_vars['item']->value['status'] == 1) {?>已启用<?php } else { ?>已停用<?php }?> </span> </td>
                                 <td class="td-manage">
                                            <a onclick="member_stop(this,'<?php echo $_smarty_tpl->tpl_vars['item']->value['tea_id'];?>
')" href="javascript:;"
                                                ...
                                                <i class="layui-icon">
                                                    <?php if ($_smarty_tpl->tpl_vars['item']->value['status'] != 1) {?>&#xe62f;<?php } else { ?>
                                                            &#xe601;<?php }?> </i> </a> <a title="编辑"
                                                                onclick="x_admin_show('编辑','/admin/teacher/update?tea_id=<?php echo $_smarty_tpl->tpl_vars['item']->value['tea_id'];?>
')"
                                                                href="javascript:;">
                                                                <i class="layui-icon">&#xe642;</i>
                                            </a>
                                            <a title="删除" onclick="member_del(this,'<?php echo $_smarty_tpl->tpl_vars['item']->value['tea_id'];?>
')" href="javascript:;">
                                                <i class="layui-icon">&#xe640;</i>
                                            </a>
                        </td>
...
>
        ...
        function member_stop(obj, id) {
            layer.confirm('确认要更改状态吗？', function (index) {
                ...
                if ($(obj).attr('title') == '启用') {
                    ...
                    //发异步把用户状态进行更改
                    $.ajax({
                        url: '/admin/teacher/change?act=do',
                        data: { 'id': id, 'status': 1 },
                        dataType: 'JSON',
                        type: 'POST',
        ...
        function member_del(obj, id) {
            layer.confirm('确认要删除吗？', function (index) {
                //发异步删除数据
                $.ajax({
                    url: '/admin/teacher/delete?act=do',
                    data: { 'tea_id': id },
                    dataType: 'JSON',
                    type: 'POST',
                    success: function (data) {
